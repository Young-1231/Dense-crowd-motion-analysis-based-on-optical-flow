...
# 从多个输入视频生成一个视频
# 用法示例：python concat_n_video.py video1.mp4 video2.mp4 video3.mp4 --output output.mp4 --fps 25
# by ginnux
...
def concat_n_video(videos, output, fps):
...
def main(args):
    concat_n_video(args.videos, args.output, args.fps)
