            ...
            if total_steps % VAL_FREQ == VAL_FREQ - 1:
                ...
                for val_dataset in args.validation:
                    if val_dataset == 'chairs':
                        ...
                        results.update(evaluate.validate_tub(model.module, dstype_list=['IM04']))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--stage', default='tub', help="determines which dataset to use for training")
