...
from .metrics import eval_metrics, eval_metrics_IE
...
def single_gpu_online_evaluation(
    ...
    for data in data_loader:
        with torch.no_grad():
            ...
            if 'IE' in metrics:
                batch_results_metrics = eval_metrics_IE(batch_flow, batch_flow_gt,
                                                 batch_valid, img_metas[0]['filename1'], img_metas[0]['filename2'], metrics)
            else:
