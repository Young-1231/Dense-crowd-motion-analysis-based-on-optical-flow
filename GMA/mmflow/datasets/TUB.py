...
class TUB(BaseDataset):
    ...
    def load_data_info(self) -> None:
        ...
        self.img1_dir = osp.join(self.data_root, 'images//IM01test')
        self.img2_dir = osp.join(self.data_root, 'images//IM01test')
        self.flow_dir = osp.join(self.data_root, 'gt_flow//IM01test')
