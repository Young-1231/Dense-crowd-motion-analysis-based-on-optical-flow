...
# python tools/test.py configs/gma/gma_TUB_1280x720_my.py checkpoint/gma_8x2_120k_mixed_368x768.pth --eval EPE
# --show-dir output/images/IM01 --out-dir output/flow/IM01
def parse_args():
